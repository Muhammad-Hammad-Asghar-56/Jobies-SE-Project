...
const JobDetail = () => {
  ...
  const getJobDetails= async () => {
    ...
    try{
      const res = await apiRequest({
        ...
        // url :"/jobs/get-jobs-detail/"+id,//authorization failed
        // url :"/jobs/get-jobs-detail/" +id ,//cant get api 404
        url :"/job/get-job-detail/"+id,
        method :"GET"
      });
      setJob(res?.data);
  ...
  const handleDeletePost = async ()=>
  {
    ...
    if(window.confirm("delete Job Post?")){
      ...
      if(res?.success){
        // alert(res?.message);
        alert("your post has been deleted succesfully");
        window.location.replace('/company-profile');
        // setTimeout(() => {
        //   window.location.reload()
        // }, 2500)
        // window.location.replace('/company/get-company');
      ...
      <div className='w-full flex flex-col md:flex-row gap-10'>
        {/* LEFT SIDE */}
        {
          ...
          <div className='w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10'>
            ...
            <div className='bg-[#625fec] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center'>
...
(
        ...
        {/* RIGHT SIDE */}
        {/* isko un-comment keron to eror ata ha
         */}
        
        <div className='w-full md:w-1/3 2xl:w-2/4 p-5 mt-20 md:mt-0'>
          <p className='text-gray-500 font-bold'>Similar Job Post</p>

          <div className='w-full flex flex-wrap gap-5'>
            {/* jobs ki jagah agr simila jobs likhein to error ata ha  */}
