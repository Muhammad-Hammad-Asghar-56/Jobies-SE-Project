...
const UploadJob = () => {
  ...
  const [jobType, setJobType] = useState("Full-Time");//wo jo place holder me show ker wa rhy hein i think
  ...
  {
    //  waqti tor per me hard code ker rha hun theek ker rha hon 
    try {
      // let id__="6560531938755318bef1d863";
     const id= user?._id;
     const res = await apiRequest({
      url:"/company/get-company/"+id,
      // url:"/company/get-company/6560531938755318bef1d863",
      method:"GET"
  ...
  return (
    <div className='container mx-auto flex flex-col md:flex-row gap-8 2xl:gap-14 bg-[#f7fdfd] px-5'>
            ...
            <div className='mt-2'>
              {
                ...
                title='Submit'
                />
                // show alert here that the job has been entered successfully
      ...
      <div className='w-full md:w-1/3 2xl:2/4 p-5 mt-20 md:mt-0'>
        <p className='text-gray-500 font-semibold'>Recently Job Post</p>
