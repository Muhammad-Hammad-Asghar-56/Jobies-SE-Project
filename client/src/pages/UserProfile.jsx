...
// import NoProfile
import NoProfile from "../assets/userprofile.png";// yup i am using it 
// import profileImage from "../assets/userprofile.png"; // i am using it he is may be using it or not  
...
const UserForm = ({ open, setOpen }) => {
  ...
  const {
    ...
    mode: "onChange",
    // defaultValues: { ...user?.user },// isko cange kia ha hum na
    defaultValues: { ...user },
  });
     ...
     try {
      ...
      const newData = uri ? { ...data, profileUrl: uri } : data;
       const res = await apiRequest({
        url:"/users/update-user",//bc hamesha yahan per ata ha error
        token:user?.token,
        data:newData,
        method:"PUT",
       });
       ...
       const newData = {token :  res?.token, ...res?.user}
        ...
        alert("Profile Updated Successfully, your information will be updated when you again log in next time..");
