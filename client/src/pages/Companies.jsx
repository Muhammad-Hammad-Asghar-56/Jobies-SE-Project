...
// import { companies } from "../utils/data";// isko bhi usny ora dia tha
// import { companies } from "../utils/data";// isko bhi usny ora dia tha
...
const Companies = () => {
  // bunch of states here(useStates):
  const [page, setPage] = useState(1);
  const [numPage, setNumPage] = useState(1);
  const [recordsCount, setRecordsCount] = useState(0);
  // const [data, setData] = useState(companies ?? []);// uskny isko change kia meny ni kia companies ?? remove ker dein
  const [data, setData] = useState( []);// uskny isko change kia meny ni kia companies ?? remove ker dein
  ...
  // if i place this function here i am getting errors
  ...
  return (
    <div className='w-full'>
      <Header
        title='Find Your Dream Company here'
